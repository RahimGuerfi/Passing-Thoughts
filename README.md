# Codecademy Passing Thoughts Project
...
In this Project, we built a place for our passing thoughts.
...
- React
- Dependencies: [react router](https://reactrouter.com/), [fontawesome](https://fontawesome.com/)
- Git, GitHub
